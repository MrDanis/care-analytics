...
const userTasksReport = ({taskStatsData,taskData}) => {
    const [chartOptions,setchartOptions] = useState({
        chart: {
            type: taskData[0].type,
            height:350
        },
        title: {
            text: ''
        ...
        series: taskData[0]?.data
    });
    console.log('Stats data is : ',taskStatsData,'Task Data is : ',taskData);
  return (
...
export default userTasksReport
