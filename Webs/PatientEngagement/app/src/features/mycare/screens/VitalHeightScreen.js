...
const VitalHeightScreen = props => {
  ...
  function getvitalDataForChart(listData) {
    ...
    if (dateType === 1) {
      ...
      days.map((day, index) => {
        ...
        objData = listData.filter((data, index) => {
          console.log('====================================');
          console.log('data in objData', data);
          console.log('====================================');
        ...
        // console.log('====================================');
        // console.log('objData temp', tempdata);
        // console.log('====================================');
        if (
          objData.length !== 0 &&
          tempdata[index] !== null &&
      ...
      for (let j = 0; j < dayFormatSample.length; j++) {
        ...
        for (let k = 0; k < listData?.length; k++) {
          ...
          if (currentTime.isBetween(afterTime, beforeTime)) {
            groupedDayData.push({
              ...
              frontColor: '#00D685', //Colors.purpleBar,
              topLabelComponent: () => (
                <Text
                  style={{
                    color: 'black',
        ...
        //  Red Color '#F44336'  Green Color #00D685
          ...
          topLabelComponent: () => (
            <View>
              <Text
                ...
                <Text>{groupedDayData[0]?.value}</Text>
              </Text>
            </View>
          ),
        };
        console.log('Test data before putting it to array : ', testData);
    ...
    // All cases are end above and now
    console.log('New list data is : ', newVitallist);
  ...
  return (
    <SafeAreaView
      ...
      <MainHeader navigation={props.navigation} name="Height">
        {/* <Modalize
          ref={modalizeRef}
...
VitalHeightScreen.navigationOptions = {
  headerShown: false,
};

export default connect()(VitalHeightScreen);
