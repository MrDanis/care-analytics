...
import { chartData } from '../data/homePageCharts'
 ...
 console.log('Data for the Aco List : ',multiSelectData);
  ...
  <MainHome>
      <div className='w-100 border border-0 border-success m-0 p-0 px-2'>
        ...
        {/* Dropdowns (End) */}
        {/* Stats (start) */}
        <Row className='my-4 m-0 border border-0 border-danger px-2'>
            <div className='col-12 col-md-7 m-0 p-0 d-flex align-items-center border border-1'>
               {/* Stats Card Display Here  */}
               <div className='w-75 d-flex align-items-center m-0 p-2 border border-0 '>
        ...
        <Row className='border border-0 border-success m-0 p-0'>
           {
            chartData&&chartData?.map((item,index)=>{
                return(
                    <div key={item?.id} 
                    className={`col-12 ${item.id===3?'col-md-12 border border-0 border-dark':'col-md-6'} m-0 px-0 p-3`}>
