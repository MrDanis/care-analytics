...
const avgHospitalizationReport = ({colors,type,data,title,discription}) => {
  ...
  return (
    <div className='order-1 d-flex flex-column justify-content-center p-3 m-0 border border-0 border-success ' style={{flex:.95}}>
...
export default avgHospitalizationReport
